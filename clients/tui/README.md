...
| `/pin [room]`, `/unpin [room]`          | Pin or unpin a room as a Matrix `m.favourite` (pin to top of the list). Writes `PUT`/`DELETE …/tags/m.favourite`. Default is the selected room. Also on `p` / `Shift-p`. Leftover `[display] pinned_rooms` migrate once; the homeserver wins if it already has any favourite.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
