...
function roomsStub() {
  ...
  const stub = {
    ...
    setRoomName: () => Promise.resolve({ ok: true as const }),
    setRoomTopic: () => Promise.resolve({ ok: true as const }),
    setRoomAvatar: () => Promise.resolve({ ok: true as const }),
    removeRoomAvatar: () => Promise.resolve({ ok: true as const }),
