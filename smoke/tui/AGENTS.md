...
human can _record_ it, needs Docker and a real terminal, and is not in any CI
...
needs a wait that only the _new_ state satisfies — see the README's "Writing a
