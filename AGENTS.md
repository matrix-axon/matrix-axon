...
| `scripts/matrix-oauth-test.sh` | ADR 0097 black-box and real interoperability lanes against pinned Synapse + MAS: API boundaries, acquisition, fresh SDK-device grant, and unsupported capability. Runnable in CI on demand via `.github/workflows/integration.yml`; secret-bearing runs upload no artifacts.                                                                     |
